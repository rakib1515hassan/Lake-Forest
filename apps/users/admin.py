...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = [
        ...
        ("Personal info", {"fields": ['name', 'phone', 'profile_img', 'dob', 'gender']}),
        # ("Personal Address", {"fields": ['division', 'sub_division', 'zip_code', 'home']}),
        ("Permissions", {"fields": ['is_superuser', 'is_admin', 'is_active', 'is_verified', 'role']}),
    ]
    ...
    add_fieldsets = [
        (
            ...
            {
                "classes": ["wide"],
                "fields": ["email", "password", "password2", "is_verified", "name", "phone", "profile_img", "role", 'dob', 'gender'],
            },
        ),
    ]
